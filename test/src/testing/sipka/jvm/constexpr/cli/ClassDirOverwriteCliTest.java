...
/**
 * Tests that the CLI main can be run on class directories, and that they are properly overwritten.
 */
@SakerTest
public class ClassDirOverwriteCliTest extends CliTestCase {
	...
	protected void runTestImpl(Map<String, String> parameters) throws Throwable {
		...
		args.add("-input");
		args.add(testCaseDirectory.toString());
		args.add("-overwrite");
