...
public final class ConstructorDeconstructorConfiguration extends DeconstructorConfiguration {
	...
	ConstructorDeconstructorConfiguration(Type executableOwner, Type[] executableParameterTypes,
		...
		super(executableOwner, Utils.CONSTRUCTOR_METHOD_NAME);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConstructorDeconstructorConfiguration other = (ConstructorDeconstructorConfiguration) obj;
